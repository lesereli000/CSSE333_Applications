...
public class Select {
    ...
    public Object[][] selectGear(String manf, String startingPrice, String link, String type, String modelNumber) throws SQLException {
        Connection connection = connect.getConnection();
        ...
        ResultSet results = stmt.executeQuery();
        Object[][] finalRet = acquireResults(results);
        connect.close();
        return finalRet;
    }
    
    public Object[][] selectHas(String EventID, String MatchID) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectHeld(String MatchOrganizationID, String EventID) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectMatch(String ID, String DateAndTime, String score, String watchingHours) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectMatchOrganization(String ID, String Contact, String Sponsor, String OrganizationName) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectParticipateIn(String PlayerID, String MatchID, String Stats) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectPlacedIn(String TeamID, String EventID, String Rank) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectPlayedOn(String TeamID, String MatchID) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectPlayer(String ID, String nation, String PlayerName, String username, String DOB, String experience, String role) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectPlaysFor(String PlayerID, String TeamID) throws SQLException {
        Connection connection = connect.getConnection();
    ...
    public Object[][] selectUses(String PlayerID, String Gear, String Since) throws SQLException {
        Connection connection = connect.getConnection();
